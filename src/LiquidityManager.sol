...
abstract contract LiquidityManager {
    ...
    function _setBuffer(Currency currency, Buffer.State memory state) internal {
    ...
    function _updateLiquidity(Currency currency) internal {
        _buffer(currency).updateLiquidity();
    }
}
